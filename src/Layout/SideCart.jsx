          ...
          <div className="cart-amount-summary">
            ...
            <ul className="summary-table">
              ...
              <li>
                <span>delivery:</span>{" "}
                <span>
                  {/*CartSummary.Delivery === 0 ? "Free" : CartSummary.Delivery*/ 'Free'}
                </span>
              </li>
              <li>
                <span>discount:</span> <span>-{/*CartSummary.Discount*/}4%</span>
              </li>
              <li>
                <span>total:</span> <span>${/*CartSummary.Total*/}200</span>
              </li>
            </ul>
